...
<li><b> Every year there are more boys born than girls. </b></li>
...
<li><b> The boy-to-girl ratio has increased over time. </b></li>
...
ggplot(present, aes(x = year, y = prop_boy_girl)) + geom_line()
```
